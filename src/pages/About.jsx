...
export default function About(){
    return (
        <div>        
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 m-5 lg:h-screen">     
                ...
                <div className="m-5">
                    ...
                    <p className="text text-slate-600 mt-3">I learn about how to makes website and mobile app from sratch. Start in learn basic HTML, CSS, Javascript and Dart.</p>
