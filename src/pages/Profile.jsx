    ...
    return (
        <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row gap-24 md:gap-28  lg:gap-52">
                ...
                <h1 className="text-[185px] md:text-[200px] lg:text-[250px] font-extrabold absolute top-[360px] lg:top-auto bottom-auto lg:left-auto text-cyan-900 drop-shadow-[-13px_11px_0px_rgba(255,255,255,1)]">Hi.</h1>
                <div className='mt-4'>
