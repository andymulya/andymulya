...
export default function Knowledge(){
    return (
        <div>
            <div className="my-10 mx-5 flex flex-col md:items-center gap-10">
                <Title title={"Knowledge"}/>
                <div className="flex gap-5 flex-col md:flex-row my-10 md:items-center md:gap-20 md:text-center">
